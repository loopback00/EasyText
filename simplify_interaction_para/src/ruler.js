var ruler = {
    ...
    initPlugin: function (params) {
        var initParams = {
            ...
            markColor: params.markColor || "CornflowerBlue",
        ...
        function drawRuler(count) {
            ...
            //添加体重数字
            cxt.beginPath();
            cxt.font = "13px Arial, sans-serif,bold ";
            cxt.fontWeight = "bold";
            cxt.fillStyle = initParams.color ? initParams.color : "#333333";
            cxt.fillStyle = initParams.color ? initParams.color : "#409EFF";
            ...
            scaleValueList.forEach(function (num, i) {
                if(num==0){
                    ...
                    cxt.fillText(num.toString()+"00", (division * i * 10) - (count * division), Math.floor(initParams.height * 0.78));
